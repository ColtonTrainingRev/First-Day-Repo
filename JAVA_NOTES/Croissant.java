public class Croissant extends Food {
    ...
    public Croissant(String name, String taste, int calorieCount, boolean isCandy, boolean isCooked, String texture, String smell) {
    ...
    @Override
    public void store() {
        System.out.println("Never store, only eat fresh");
    }
